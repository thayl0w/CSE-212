...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:
    // The test expects Bob to be the first person retrieved, but Sue is returned first.
    ...
    // Defect(s) Found: 
    //The test expects Bob to be the first person retrieved after adding George, but Sue is being returned.
    ...
    // Defect(s) Found: 
    // No defect found; test should pass as expected.
